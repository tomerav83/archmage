...
// What the rack drags onto the board. A frame is drawn, never dragged — see
// docs/nesting.md — so it stands in TYPES for the registry and the enclose
// menus and nowhere the rack reads from: not the shelves, not the search.
export const PALETTE = (Object.entries(TYPES) as [TypeKey, ElementType][]).filter(
  ([, t]) => !t.frame,
)
